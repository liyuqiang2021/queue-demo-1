...
var removeFromList = function removeFromList(list, node) {
  ...
  while (x !== node && x !== null) {
    //如果node不在list中，list就可能为null
    p = x;
    x = x.next;
  }

  if (x === null) {
    //若list为null，则不需要删除，直接return，false表示无法删除不在list里的节点
    return false;
  } else if (x === p) {
    //这说明要删除的节点是第一个节点
    p = x.next;
...
},{}],"C:/Users/john/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/john/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","list.js"], null)
